...
- Updated the release metadata check for the current blocked-roadmap heading style.
...
- `.github/workflows/build.yml`: per-era APK loop. Loops `set_era.py` through
  all 6 eras (ios14 to ios18, ios26), builds a signed APK per era, and publishes
